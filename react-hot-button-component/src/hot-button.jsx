...
class HotBtn extends React.Component {
  ...
  render() {
    if (this.state.clicks < 4) {
      ...
      return (
        <button className="btn-purple" onClick={this.handleClick}>
          Hot Button
        </button>
      );
    } else if (this.state.clicks >= 6 && this.state.clicks < 12) {
      return (
        <button className="btn-pink" onClick={this.handleClick}>
          Hot Button
        </button>
      );
      ...
      return (
        <button className="btn-white" onClick={this.handleClick}>
          Hot Button
        </button>
      );
    }
